...
Для получения набора всех доступных параметров конкретного устройства отправьте запрос ``{"cmd":1}``. Ответ для терморегулятора oz без датчика воздуха, выпуска до июня 2025 г.:
...
.. table:: **Список параметров**
   ...
   80       1(int8)        buttonMinusCor             поправка чувствительности сенсоров клавиши от -30 до 30
   81       1(int8)        buttonMenuCor              поправка чувствительности сенсоров клавиши от -30 до 30
   82       1(int8)        buttonPlusCor              поправка чувствительности сенсоров клавиши от -30 до 30
